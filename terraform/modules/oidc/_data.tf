...
data "aws_iam_policy_document" "scoped_two" {
  statement {
    ...
    resources = [
      ...
      "arn:aws:ec2:${var.region}:${data.aws_caller_identity.current.account_id}:vpc/${local.resource_name_prefix}",
      ...
      "arn:aws:rds:${var.region}:${data.aws_caller_identity.current.account_id}:db:${local.resource_name_prefix}",
...
data "aws_iam_policy_document" "request_tags_create_actions" {
  statement {
    ...
    resources = [
      ...
      "arn:aws:ec2:${var.region}:${data.aws_caller_identity.current.account_id}:elastic-ip/*",
      "arn:aws:ecr:${var.region}:${data.aws_caller_identity.current.account_id}:repository/*",
      "arn:aws:ecs:${var.region}:${data.aws_caller_identity.current.account_id}:service/${local.resource_name_prefix}/*",
      "arn:aws:ecs:${var.region}:${data.aws_caller_identity.current.account_id}:cluster/${local.resource_name_prefix}",
      "arn:aws:elasticloadbalancing:${var.region}:${data.aws_caller_identity.current.account_id}:listener/app/${local.resource_name_prefix}/*",
      "arn:aws:elasticloadbalancing:${var.region}:${data.aws_caller_identity.current.account_id}:loadbalancer/app/${local.resource_name_prefix}/*",
      "arn:aws:elasticloadbalancing:${var.region}:${data.aws_caller_identity.current.account_id}:targetgroup/${local.resource_name_prefix}*/*",
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/${local.resource_name_prefix}*",
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:policy/${local.resource_name_prefix}*",
...
data "aws_iam_policy_document" "resource_tags_update_actions" {
  statement {
    ...
    resources = [
      ...
      "arn:aws:ecr:${var.region}:${data.aws_caller_identity.current.account_id}:repository/*",
      "arn:aws:elasticloadbalancing:${var.region}:${data.aws_caller_identity.current.account_id}:listener/app/${local.resource_name_prefix}/*",
      "arn:aws:elasticloadbalancing:${var.region}:${data.aws_caller_identity.current.account_id}:listener-rule/app/${local.resource_name_prefix}/*",
      "arn:aws:elasticloadbalancing:${var.region}:${data.aws_caller_identity.current.account_id}:loadbalancer/app/${local.resource_name_prefix}/*",
      "arn:aws:elasticloadbalancing:${var.region}:${data.aws_caller_identity.current.account_id}:targetgroup/${local.resource_name_prefix}*/*",
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/${local.resource_name_prefix}*",
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:policy/${local.resource_name_prefix}*",
...
data "aws_iam_policy_document" "resource_tags_delete_actions" {
  statement {
    ...
    resources = [
      ...
      "arn:aws:rds:${var.region}:${data.aws_caller_identity.current.account_id}:subgrp:*",
      "arn:aws:rds:${var.region}:${data.aws_caller_identity.current.account_id}:db:${local.resource_name_prefix}",
      "arn:aws:rds:${var.region}:${data.aws_caller_identity.current.account_id}:pg:${local.resource_name_prefix}",
